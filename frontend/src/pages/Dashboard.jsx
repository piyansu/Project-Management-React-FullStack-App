...
const Dashboard = () => {
    ...
    const teamActivity = [
        { user: 'Sarah J.', action: 'completed', task: 'Header component design', time: '2 hours ago' },
        { user: 'Mike R.', action: 'started', task: 'API endpoint testing', time: '4 hours ago' },
        { user: 'Lisa K.', action: 'updated', task: 'Mobile wireframes', time: '6 hours ago' },
        { user: 'Tom L.', action: 'completed', task: 'Database migration', time: '1 day ago' }
    ];
    ...
    return (
        <div className="space-y-6 pb-10">
            ...
            <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
                <div>
                    <h2 className="mt-1 text-xl font-bold">Welcome back! Here's what's happening with your projects.</h2>
                </div>
                <div className="flex items-center space-x-3">
                    ...
                    <button className="bg-blue-600 hover:bg-blue-700 text-white px-4 py-2 rounded-lg flex items-center space-x-2 transition-colors duration-200 cursor-pointer">
